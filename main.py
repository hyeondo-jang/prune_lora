...
if __name__ == '__main__':
    ...
    flags.DEFINE_enum('admm_projection_mode', 'identity', ['identity', 'activation', 'gradient','momentum'], 'Generalized projection mode for ADMM (identity/activation/gradient).')
    ...
    flags.DEFINE_string('admm_dual_dtype', 'fp32', 'Dtype for ADMM dual variable (fp32 or bf16).')
