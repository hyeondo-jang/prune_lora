...
def get_admm_optimizer(base_optimizer_cls):
    ...
    class ADMMOptimizer(base_optimizer_cls):
        ...
        def __init__(
            ...
            lmda_schedule_mode: str = 'constant', # 'constant', 'linear', 'cosine', 'adaptive_boyd'
            ...
            projection_bias_correction: bool = False, # use bias correction in projection (for momentum/taylor)
